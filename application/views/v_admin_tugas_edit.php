      ...
      <div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
				  <div class="row">
				  <?php echo form_open_multipart("$level/tugas_aksi_ubah/".$tbl_tugas->tugas_id); ?>
					<div class="col-md-4">
					  <div class="form-group">
						<label>Nama Tugas</label>
						<input type="text" class="form-control" name="tugas_nama" value="<?php echo set_value('tugas_nama', $tbl_tugas->tugas_nama); ?>">
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<input type="hidden" name="tugas_file" value="<?php echo set_value('tugas_file', $tbl_tugas->tugas_file); ?>">
					  </div>
					  <div class="form-group">
					...
					<div class="col-md-4">
					  <div class="form-group" style="text-align:center;">
						<img class="img img-responsive user-image" id="blah" src="<?php echo base_url();?>assets/dist/img/tugas/<?php echo $tbl_tugas->tugas_file."?".strtotime("now");?>">
					  </div>
					</div>
					<?php echo form_close(); ?>
				  </div>
